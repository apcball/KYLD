...
class SaleOrder(models.Model):
    ...
    trade_channel_id = fields.Many2one('marketplace.trade.channel', string='Trade Channel')

    def _prepare_invoice(self):
        """Extend invoice preparation to copy trade_channel_id from the sale order.
        ...
        vals['trade_channel_id'] = self.trade_channel_id.id if self.trade_channel_id else False
        return vals
