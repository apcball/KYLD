...
class BillLinkWizard(models.TransientModel):
    ...
    vendor_bill_id = fields.Many2one('account.move', string='Vendor Bill', required=True,
                                   domain="[('move_type', '=', 'in_invoice'), ('state', '=', 'draft'), ('trade_channel_id', '=', trade_channel_id)]")
    trade_channel_id = fields.Many2one(related='marketplace_document_id.trade_channel_id', string='Trade Channel', readonly=True)
