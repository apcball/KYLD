{
    ...
    'security/employee_purchase_requisition_rule.xml',
    'security/disable_stock_location_rule.xml',
    'security/stock_location_multi_company_rule.xml',
    'security/stock_warehouse_multi_company_rule.xml',
    'security/stock_location_admin_rule.xml',
    'security/stock_admin_access_rules.xml',
